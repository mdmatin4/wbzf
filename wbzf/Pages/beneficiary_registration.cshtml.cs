...
{
    public class beneficiary_registrationModel : PageModel
    {
        private IUnitOfWork _unitOfWork;
        public string company_terms;
        private readonly Microsoft.AspNetCore.Identity.UI.Services.IEmailSender _emailSender;
        public ScholarshipApplication scholarshipApplication { get; set; }
        public beneficiary_registrationModel(IUnitOfWork unitOfWork, Microsoft.AspNetCore.Identity.UI.Services.IEmailSender emailSender)
        {
