...
namespace wbzf.Areas.Identity.Pages.Account
{
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    else
                    {
                        ...
                        {
                            if (role == SD.ScrutinyOfficer)
                            {
                                await _userManager.AddToRoleAsync(user, SD.ScrutinyOfficer);
                            }

                            else
                            {
                                await _userManager.AddToRoleAsync(user, SD.FinanceOfficer);
                            }
